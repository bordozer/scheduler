...
@Service
public class SchedulerTaskEditDtoConverterImpl extends AbstractDtoConverter<SchedulerTask, SchedulerTaskEditDto> {

	@Inject
	private RemoteJobEditDtoConverterImpl remoteJobEditDtoConverter;
