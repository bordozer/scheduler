...
@Service
public class SchedulerTaskDtoConverterImpl extends AbstractDtoConverter<SchedulerTask, SchedulerTaskDto> {

	@Inject
	private RemoteJobDtoConverterImpl remoteJobDtoConverter;
