...
public class SchedulerTaskEntityConverterImpl implements SchedulerTaskEntityConverter {
	...
	@Override
	public void populateEntity(final schemway.core.entities.SchedulerTaskEntity entity, final SchedulerTask model) {
	...
	@Override
	public SchedulerTask toModel(final schemway.core.entities.SchedulerTaskEntity entity) {
		Assert.notNull(entity, ENTITY_MUST_NOT_BE_NULL);
