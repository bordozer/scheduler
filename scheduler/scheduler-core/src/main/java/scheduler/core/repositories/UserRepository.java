...
@Repository
public interface UserRepository extends JpaRepository<scheduler.core.entities.UserEntity, Long> {
...
//	@Cacheable( value = CACHE_ENTRY, key = "#userid" )
	scheduler.core.entities.UserEntity findById(Long userId);
...
//	@Cacheable( value = CACHE_ENTRY, key = "#p0" )
	...
	scheduler.core.entities.UserEntity findByLogin(@Param("login") String login);
