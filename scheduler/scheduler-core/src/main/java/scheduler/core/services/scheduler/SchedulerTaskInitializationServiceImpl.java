...
public class SchedulerTaskInitializationServiceImpl implements SchedulerTaskInitializationService {
    ...
    @Inject
    private scheduler.core.services.tasks.SchedulerTaskService schedulerTaskService;

    @Inject
    private scheduler.core.services.jobs.JobExecutionService jobExecutionService;
