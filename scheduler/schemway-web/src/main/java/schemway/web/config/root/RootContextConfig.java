...
import schemway.core.services.SystemVarsServiceImpl;
...
@ComponentScan({
		...
		, "schemway.web.security"
		, "schemway.web.controllers"
		, "schemway.web.converters"
		, "schemway.scheduler.jobs"
		, "schemway.scheduler.services"
})
