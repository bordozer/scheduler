...
JAVA_HOME=/opt/java/jdk1.8.0_20 ; mvn clean install jetty:run -Djetty.port=9097 -Dspring.profiles.active=development
...
#jetty:run -Djetty.port=9097 -Dspring.profiles.active=development -Dnoverify -Djavaagent:/home/blu/.IntelliJIdea13/config/plugins/jr-ide-idea/lib/jrebel6/jrebel.jar